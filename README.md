...
(i) Python3 must be installed and configured in the environment for use with `reticulate`. Additionally, dependencies for Python libraries can be installed using the following command:
...
(ii) Installing Cell2Spatial package
